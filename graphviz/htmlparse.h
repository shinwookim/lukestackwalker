...
#ifndef YY_HTML_COMMON_HTMLPARSE_H_INCLUDED
# define YY_HTML_COMMON_HTMLPARSE_H_INCLUDED
/* Debug traces.  */
#ifndef HTMLDEBUG
# if defined YYDEBUG
#if YYDEBUG
...
#endif /* !YY_HTML_COMMON_HTMLPARSE_H_INCLUDED  */
